# Concise Output Style — built-in definition

Source: Claude Code v2.1.263 binary, built-in output style registry.
...
Concise: {
  ...
  prompt: <see below>,
  turnReminder: "Be concise: lead with the result, skip preamble and narration, keep only what the user needs."
}
```
